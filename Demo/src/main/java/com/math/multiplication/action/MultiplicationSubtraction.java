...
public class MultiplicationSubtraction   {
	...
	List<MultiplicationSubtraction> multiplications = new ArrayList<MultiplicationSubtraction>();
	
	public MultiplicationSubtraction(){
		
	}
	
	public MultiplicationSubtraction(String number, String multiplier,int problemNumber) {
		this.number = number;
	...
	public List<MultiplicationSubtraction> getMultiplications() {
		return multiplications;
	}

	public void setMultiplications(List<MultiplicationSubtraction> multiplications) {
	...
	public MultiplicationSubtraction getFormattedProblem(int number,int multiplier,int problemNumber){
        String spaceNum="";
        String spaceMul="";
        ...
        if (number>multiplier){
          return new MultiplicationSubtraction(spaceNum+number,"-"+spaceMul + multiplier,problemNumber);
        }
        else
        {
          return new MultiplicationSubtraction(spaceNum+multiplier,"-"+spaceMul + number,problemNumber);	
        }
	}
